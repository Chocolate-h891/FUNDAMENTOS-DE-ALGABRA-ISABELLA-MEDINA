...
$1\times 2^7+ 1\times 2^4+ 1\times 2^3+ 1\times 2^0=128 +16+8+1= 153$

$75)  11001100$

$1\times 2^7+ 1\times 2^6+ 1\times 2^3+ 1\times 2^2=128+64+8+4= 204$

$76)  01111011$

$1\times 2^6+ 1\times 2^5+ 1\times 2^4+ 1\times 2^3+ 1\times 2+ 1\times 2^0= 64+32+16+8+2+1= 123$

$77)  00000000 11111111$

$1\times 2^7+ 1\times 2^6+ 1\times 2^5+ 1\times 2^4+ 1\times 2^3+ 1\times 2^2+ 1\times 2+ 1\times 2^0= 128+64+32+16+8+4+2+1= 255$
...
0  000 001 111 000  000

1  7  0  0

$84)  00000101 01010101$

0   000    010 101  010   101
